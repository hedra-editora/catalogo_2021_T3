...
\bigskip
\noindent{}\textcolor{gray}{\footnotesize\slsc{\textls[-15]{Capítulo \textit{Lygia Clark: seis céulas}, presente no volume “Arte contemporânea brasileira (1970--1999)”.}}}
\end{multicols}
...
\item Diários de Vincent \textbf{Evando Nascimento}
...
\item Todos os lugares \textbf{Alex Cerveny; Renato Rezende; Rodrigo Petrônio}
\item Onde late um cachorro doido \textbf{Moisés Alves}
\item O tropo tropicalista \textbf{João Camillo Penna}
\item Experimentum linguae \textbf{Giorgio Agamben; Cláudio Oliveira}
...
\item Asas de Saturno \textbf{Maria João Cantinho}
\item Experiência e arte contemporânea \textbf{Ana Kiffer; Renato Rezende; Christopher Bident}
\item A reflexão atuante \textbf{Sergio Cohn}
\item Escritos sobre fotografia contemporânea brasileira \textbf{Antonio Fatorelli; Leandro Pimentel; Victa de Carvalho}
