...
% Não se alcançam ideias claras isolando-se dos outros e do mundo, em um movimento introspectivo que favoreceria a inspeção da razão por ela mesma. Deleuze e Guattari ressaltam ainda o antiplatonismo dessa espécie de diálogo, que é de fato um anti-diálogo: o texto salienta que começamos a falar com alguém sobre uma ideia nebulosa não para que o interlocutor nos esclareça, mas para que o próprio movimento inicial da frase, infletindo-se em direção a seu desfecho, perfaça e clarifique a ideia. Portanto, nem pensamento interiorizado nem diálogo metódico; em Kleist, não perguntar, apostar na força viva do discurso e no acaso dos encontros faz parte da cena em que o pensamento pode ser fabricado. De fora, portanto, e em trocas presenciais com corpos alheios.
...
\item Esferas da inssureição \textbf{Suely Rolnik; Paul B. Preciado}
...
\item Bash Back \textbf{Bash Back}
\item As existências mínimas \textbf{David Lapoujade}
\item Manifesto contrassexual \textbf{Beatriz Preciado; Marie-Hélène Bourcier}
\item Ensaios do assombro \textbf{Peter Pál Pelbart}
\item Pornotopia \textbf{Paul B. Preciado}
\item Ética bixa \textbf{Paco Vidarte; Pablo Cardellino Soto; Maria Selenir Nunes dos Santos}
\item Os vagabundos eficazes \textbf{Fernand Deligny}
\item Povo em lágrimas, povo em armas \textbf{Georges Didi-Huberman}
\item Um piano nas barricadas \textbf{N-1 edições}
\item Impressões de Michel Foucault \textbf{Roberto Machado}
\item Deleuze, os movimentos aberrantes \textbf{David Lapoujade; Laymert Garcia dos Santos}
\item Fascismo ou revolução? \textbf{Maurizio Lazzarato; Takashi Wakamatsu; Fernando Scheibe}
\item Fernando Pessoa ou a Metafísica das Sensações \textbf{José Gil}
\item O enigma da revolta \textbf{Michel Foucault; Lorena Balbino; Christian Laval}
\item Cartas e outros textos \textbf{Gilles Deleuze; David Lapoujade}
...
\item Arqueofeminismo \textbf{Maxime Rovere}
